      ...
      <div className='max-w-6xl mx-auto'>
        <div className=' rounded-md border-[0.5px] border-slate-300 text-center p-14 '>
          <div className='mx-auto text-center  '>
            ...
            <h1 className='text-5xl text-orange-600 border-red-400 font-bold  mb-12 py-4'>
              ...
              <div className='flex lg:gap-[365px] mt-20 mb-10'>
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex'>
                    ...
                    <div></div>
                    <div className='mb-3'>
                      <p className='text-lg font-bold lg:mr-[136px] mb-2'>
                        Upload Your Photo*
                      </p>
                      <input
                        {...register("image")}
                ...
                <div className='flex-1 mb-5'>
                  <label className='form-control w-full '>
                    ...
                    <input
                      {...register("skill")}
                      type='text'
                      placeholder='eg. HTML,CSS,React ect..'
                      required
                      className='input input-bordered w-full'
                    />
                  </label>
                ...
                <div className='flex-1 mb-5'>
                  ...
                  <label className='form-control w-full mt-3'>
                    ...
                    <input
                      ...
                      type='text'
                      placeholder='eg. React, Node.js ect..'
                      required
                      className='input input-bordered w-full'
                    />
                  </label>
