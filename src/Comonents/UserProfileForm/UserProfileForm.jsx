            ...
            <form onSubmit={handleSubmit(onSubmit)} className=''>
              ...
              <div className="md:flex gap-16 mb-10">
                ...
                <div className="w-full">
                  ...
                  <h3 className='text-slate-600 text-lg font-semibold'>Upload Your Photo</h3>
                  <input {...register("image", { required: true })} type="file" className="file-input file-input-bordered file-input-md w-full " />
                  {errors.image && <span className="mt-2 text-red-600 w-full">Photo is required </span>}
                  ...
                  <textarea  {...register("aboutDescription", { required: true })} type="text" placeholder='Describe Yourself' className='pl-2 rounded-md py-2 border-[0.0px] border-black    w-full text-lg font-medium' cols="30" rows="2"></textarea>
              ...
              <div className="md:flex gap-16 mb-10 mt-10">
                ...
                <div className="w-full">
                  ...
                  <input className='pl-2 rounded-md py-2    w-full text-lg font-medium '
                    {...register("degree", { required: true })} type="type" placeholder='e.g Bachelor' id="" />
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <select  {...register("educationStartMonth", { required: true })} className="text-lg font-medium rounded-md py-2 w-full" id="">
                      ...
                      <div>
                        <select  {...register("educationStartYear", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select  {...register("educationEndMonth", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                      ...
                      <div>
                        <select  {...register("educationEndYear", { required: true })} className="text-lg font-medium rounded-md py-2 w-full" id="">
                  ...
                  <h3 className='text-slate-600 text-lg font-semibold'>Description</h3>
                  <textarea  {...register("educationDescription", { required: true })} type="text" placeholder='Add Your Description' className='pl-2 rounded-md py-2    w-full text-lg font-medium ' cols="30" rows="2"></textarea>
              ...
              <div className="md:flex gap-16 mb-10 mt-10">
                ...
                <div className="w-full">
                  ...
                  <input className='pl-2 rounded-md py-2    w-full text-lg font-medium '
                    {...register("projectLink", { required: true })} type="url" placeholder='Add your project link' id="" />
                  {errors.projectLink && <span className="mt-2 text-red-600 w-full">This Field is required </span>}

                  <h3 className='text-slate-600 text-lg font-semibold'>Technologies</h3>
                  <input className='pl-2 rounded-md py-2 border-[0.0px] border-black    w-full text-lg font-medium '
                    {...register("technologies", { required: true })} type="text" placeholder='e.g HTML, Css, React' id="" />
                  {errors.technologies && <span className="mt-2 text-red-600 w-full">This Field is required </span>}
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <select  {...register("projectStartMonth", { required: true })} className="text-lg font-medium rounded-md py-2 w-full" id="">
                      ...
                      <div>
                        <select  {...register("projectStartYear", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select  {...register("projectEndMonth", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                      ...
                      <div>
                        <select  {...register("projectEndYear", { required: true })} className="text-lg font-medium rounded-md py-2 w-full" id="">
                  ...
                  <h3 className='text-slate-600 text-lg font-semibold'>Description</h3>
                  <textarea  {...register("projectDescription", { required: true })} type="text" placeholder='Describe your project' className='pl-2 rounded-md py-2    w-full text-lg font-medium ' cols="30" rows="2"></textarea>
                  {errors.projectDescription && <span className="mt-2 text-red-600 w-full">description is required </span>}
                </div>
              </div>
              <p className="border-[0.5px] border-slate-400 mt-2 mb-1 w-full"></p>
              ...
              <div className="md:flex gap-16 mb-10 mt-10">
                ...
                <div className="w-full">
                  ...
                  {errors.skills && <span className="mt-2 text-red-600 w-full">This Field is required </span>}
                </div>
              </div>
              <p className="border-[0.5px] border-slate-400 mt-2 mb-1 w-full"></p>
                ...
                <div className="w-full">
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      ...
                      <div>
                        <select  {...register("jobStartYear", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                  ...
                  <div className="">
                    ...
                    <div className=" grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select  {...register("jobEndMonth", { required: true })} className="text-lg font-medium rounded-md py-2  w-full" id="">
                      ...
                      <div>
                        <select  {...register("jobEndYear", { required: true })} className="text-lg font-medium rounded-md py-2 w-full" id="">
                  ...
                  <h3 className='text-slate-600 text-lg font-semibold'>Description</h3>
                  <textarea  {...register("jobDescription", { required: true })} type="text" placeholder='Describe your experience' className='pl-2 rounded-md py-2    w-full text-lg font-medium ' cols="30" rows="2"></textarea>
