    ...
    return (
        <div className="container mx-auto mt-20">
             ...
             <div className="grid gap-20  grid-cols-1 md:grid-cols-2 lg:grid-cols-2  mx-5   md:mx-5 lg:mx-60 ">
              {/* First Card */}
               <div className="border-2 shadow-xl border-yellow-200 rounded-lg py-5 w-full overflow-y-scroll">
              ...
              {/* Second Card */}
               <div className="border-2 shadow-lg border-orange-300 rounded-lg py-5 w-full overflow-y-scroll">
