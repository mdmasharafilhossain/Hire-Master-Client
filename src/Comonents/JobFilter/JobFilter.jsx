...
const JobFilter = ({
  ...
  return (
    <form
      ...
      className="mx-auto my-10 lg:my-0 flex flex-col w-full space-y-5 lg:space-y-2 "
    >
      <div className="space-y-3">
        ...
        <input
          ...
          className="outline-none w-3/4 lg:w-full py-2 pl-2 rounded-full border text-black"
      ...
      <div className="lg:grid lg:grid-cols-3 items-center w-full space-y-3 lg:space-y-0 space-x-2 md:space-x-4 lg:space-x-0">
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              handleCheckboxChange("Full-time", e.target.checked)
            }
            className="mr-1"
          />
          Full-time
        ...
        <label>
          <input
            ...
            onChange={(e) =>
              handleCheckboxChange("Part-time", e.target.checked)
            }
            className="mr-1"
          />
          Part-time
      ...
      <div className="md:flex gap-x-5 lg:flex-col w-full space-y-3 lg:space-y-5">
        ...
        <div className="rounded-xl w-1/2 md:w-1/5 lg:w-full border gap-y-1 px-2 flex flex-col">
          ...
          <input
            type="text"
            name="salaryRange"
            className="outline-none text-center text-black rounded"
            value={`$ ${value[0]}`}
            readOnly
          />
        </div>
