...
const ProfileHead = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const userRes = await axiosPublic.patch(
      `/UsersProfile/profileHead/${myProfileData._id}`,
      userInfo
    );
  ...
  return (
    <div>
      {profileData.map((data) => (
        <div
          key={data._id}
          className="mt-10 max-w-5xl mx-4 mb-4 md:mx-auto border-[0.5px] border-slate-400 p-10 bg-[#f4f2ee] rounded-lg"
        >
          <div className="">
            <div>
              <form onSubmit={handleSubmit(onSubmit)} className=" ">
                ...
                <div>
                  ...
                  <button
                    ...
                    className=" btn px-8  bg-[#FF444A] text-white rounded-md hover:text-black hover:bg-red-200 text-lg font-semibold"
                  >
                    Edit
                  </button>
                </div>
