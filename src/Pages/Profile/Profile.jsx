...
const Profile = () => {
   ...
   console.log(profileData)
    ...
    return (
        <div>
            {
               profileData.map(data =><div key={data._id} className="max-w-6xl mx-auto ">
               ...
               <div className="bg-white w-full rounded-md border-[0.5px] border-slate-300 p-6 ">
                       ...
                       <div className="md:flex  gap-8">
                           ...
                           <div className="">
                               <div className="flex justify-between items-center">
                                   ...
                                   <h3 className="text-slate-600 font-semibold">{data.UniversityName}</h3>
                               </div>
                               <div className="md:flex justify-between mb-2">
                                   <h3 className="text-slate-600 font-semibold">{data.role}</h3>
                                   <h3 className="text-slate-600 font-semibold">{data.location}</h3>
                               </div>
                               <h3 className="w-full text-slate-600 text-lg font-normal">{data.bio}</h3>
                                 <div className="flex gap-4 mt-4">
                                 <Link to={data.linkedin}>
                                   <h3 className=" text-xl "><FaLinkedin></FaLinkedin></h3>
                                 </Link>
                                 <Link to={data.portfolio}>
                                    <h3 className=" text-2xl "><TbWorld></TbWorld></h3>
                                 </Link>
                                 <Link to={data.Github}>
                   ...
                   <div className="mt-4  border-[0.5px] border-slate-300  hover:bg-blue-50  hover:drop-shadow-lg  bg-white p-8 rounded-lg">
                       ...
                       <div className="ml-4">
                           <h3 className="text-slate-600 font-semibold">{data.UniversityName}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.Degree}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.GraduationDate}</h3>
                       </div>
                   ...
                   <div className="mt-4 container  border-[0.5px] border-slate-300 hover:bg-blue-50  hover:drop-shadow-lg  bg-white p-8 rounded-lg">
                       ...
                       <div className="ml-4">
                           <h3 className="text-slate-600 font-semibold">{data.ProjectName}</h3>
                           <h3 className="text-slate-600 font-semibold mb-2">{data.StartDate} | {data.EndDate}</h3>
                           <h3 className="text-slate-600 font-semibold mb-2">{data.ProjectDescription}</h3>
                   ...
                   <div className="mt-4  border-[0.5px] border-slate-300 hover:bg-blue-50 bg-white p-8 rounded-lg hover:drop-shadow-lg">
                       ...
                       <div className="ml-4 mb-10">
                           <h3 className="text-slate-600 font-semibold">{data.JobTitle}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.JobType}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.CompanyName}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.Location}</h3>
                           <h3 className="text-slate-600 font-semibold">{data.WorkingStartDate} | {data.WorkingEndDate}</h3>
                       </div>
                   </div>
               </div>
           </div>
