    ...
    <div>
      ...
      {myData ? (
            ...
            <div className=" w-full rounded-md border-[0.5px] border-slate-300 p-6  ">
              <div className=" p-8 rounded-lg border-[0.5px] border-slate-300 hover:drop-shadow-lg ">
                ...
                <div className="md:flex  gap-8 hover:bg-blue-50 hover:text-black">
                  ...
                  <div className="">
                          ...
                          <div>
                            <div className="tooltip" data-tip="Premium">
                              <img
                                ...
                                src="https://i.ibb.co/cTxs13b/free-premium-1891072-1597985.webp"
                                alt=""
                              />
                            </div>
                          </div>
                    ...
                    <div className="md:flex justify-between mb-2">
                      <h3 className=" font-semibold">{myData?.headline}</h3>
                      <h3 className=" font-semibold">{myData?.location}</h3>
                    </div>
                ...
                <div className="p-8 rounded-lg border-[0.5px] border-slate-300 hover:bg-blue-50 hover:text-black hover:drop-shadow-lg">
                  ...
                  <div className="ml-4">
                    <h3 className=" font-semibold">{myData?.UniversityName}</h3>
                    <h3 className=" font-semibold">{myData?.degree}</h3>
                ...
                <div className="p-8 rounded-lg border-[0.5px] border-slate-300 hover:bg-blue-50 hover:text-black hover:drop-shadow-lg">
                  ...
                  <div className="ml-4">
                    <h3 className=" font-semibold">{myData?.projectName}</h3>
                ...
                <div className="p-8 rounded-lg border-[0.5px] border-slate-300 hover:bg-blue-50 hover:text-black hover:drop-shadow-lg">
                  ...
                  <div className="ml-4 mb-10">
                    <h3 className=" font-semibold">{myData?.jobTitle}</h3>
                    <h3 className=" font-semibold">{myData?.jobType}</h3>
                    <h3 className=" font-semibold">{myData?.companyName}</h3>
                    <h3 className=" font-semibold">{myData?.location}</h3>
                    <h3 className=" font-semibold">
              ...
              <div>
                <div className="mt-4  border-[0.5px] border-slate-300 hover:bg-blue-50 hover:text-black  p-8 rounded-lg hover:drop-shadow-lg">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#FF3811] text-lg font-medium me-2 px-2.5 py-0.5 roundeddark:text-red-400 border border-red-400">
                      Free For Premium
                    </span>
                  </div>
                  {premiumUser ? (
        ...
        <div className="text-center m-auto mt-40">
          <h2 className="text-4xl ">Profile have not set yet</h2>
          <Link to="/profileForm" className="my-5 text-sm hover:underline">
